...
function(compile_library)
	...
	cmake_parse_arguments("COMPILE"
		...
		message("COMPILE_DEBUG                     = ${COMPILE_DEBUG}")
#	if (COMPILE_DEBUG)
...
#	endif()
	...
	if (COMPILE_CREATE_STATIC_LIBRARY)
		...
		set_target_properties(${TARGET_NAME_STATIC}
			PROPERTIES
				OUTPUT_NAME "${FLAME_NAMESPACE}${COMPILE_LIBRARY_NAME}"
		)
	...
	if (COMPILE_CREATE_SHARED_LIBRARY)
		...
		set_target_properties(${TARGET_NAME_SHARED}
			PROPERTIES
				OUTPUT_NAME "${FLAME_NAMESPACE}${COMPILE_LIBRARY_NAME}"
		)
