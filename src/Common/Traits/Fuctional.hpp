#ifndef COMMON_TRAITS_FUCTIONAL_HPP
#define COMMON_TRAITS_FUCTIONAL_HPP

#include <Common/Traits/CreationProhibitions.hpp>
#include <Common/Traits/Numbers.hpp>
...
#endif // COMMON_TRAITS_FUCTIONAL_HPP
