...
FunctionList3::FunctionList3() noexcept
		: FunctionList3(Parent{})
{}

FunctionList3::FunctionList3(const FunctionList3 &functionList) noexcept
		: FunctionList3(static_cast<const Parent &>(functionList))
{}

FunctionList3::FunctionList3(const Parent &functionList) noexcept
{
	operator=(functionList);
}

FunctionList3::FunctionList3(
...
) noexcept
{
	...
	this->C_GetInterfaceList = getInterfaceListCallback;
	this->C_GetInterface = getInterfaceCallback;
	this->C_LoginUser = loginUserCallback;
	this->C_SessionCancel = sessionCancelCallback;
	this->C_MessageEncryptInit = messageEncryptInitCallback;
	this->C_EncryptMessage = encryptMessageCallback;
	this->C_EncryptMessageBegin = encryptMessageBeginCallback;
	this->C_EncryptMessageNext = encryptMessageNextCallback;
	this->C_MessageEncryptFinal = messageEncryptFinalCallback;
	this->C_MessageDecryptInit = messageDecryptInitCallback;
	this->C_DecryptMessage = decryptMessageCallback;
	this->C_DecryptMessageBegin = decryptMessageBeginCallback;
	this->C_DecryptMessageNext = decryptMessageNextCallback;
	this->C_MessageDecryptFinal = messageDecryptFinalCallback;
	this->C_MessageSignInit = messageSignInitCallback;
	this->C_SignMessage = signMessageCallback;
	this->C_SignMessageBegin = signMessageBeginCallback;
	this->C_SignMessageNext = signMessageNextCallback;
	this->C_MessageSignFinal = messageSignFinalCallback;
	this->C_MessageVerifyInit = messageVerifyInitCallback;
	this->C_VerifyMessage = verifyMessageCallback;
	this->C_VerifyMessageBegin = verifyMessageBeginCallback;
	this->C_VerifyMessageNext = verifyMessageNextCallback;
	this->C_MessageVerifyFinal = messageVerifyFinalCallback;
}

FunctionList3 &FunctionList3::operator=(const FunctionList3 &functionList) noexcept
{
	return operator=(static_cast<const Parent &>(functionList));
}

FunctionList3 &FunctionList3::operator=(const Parent &functionList) noexcept
{
	...
	C_GetInterfaceList = functionList.C_GetInterfaceList;
	C_GetInterface = functionList.C_GetInterface;
	C_LoginUser = functionList.C_LoginUser;
	C_SessionCancel = functionList.C_SessionCancel;
	C_MessageEncryptInit = functionList.C_MessageEncryptInit;
	C_EncryptMessage = functionList.C_EncryptMessage;
	C_EncryptMessageBegin = functionList.C_EncryptMessageBegin;
	C_EncryptMessageNext = functionList.C_EncryptMessageNext;
	C_MessageEncryptFinal = functionList.C_MessageEncryptFinal;
	C_DecryptMessage = functionList.C_DecryptMessage;
	C_DecryptMessageBegin = functionList.C_DecryptMessageBegin;
	C_DecryptMessageNext = functionList.C_DecryptMessageNext;
	C_MessageDecryptFinal = functionList.C_MessageDecryptFinal;
	C_MessageSignInit = functionList.C_MessageSignInit;
	C_SignMessage = functionList.C_SignMessage;
	C_SignMessageBegin = functionList.C_SignMessageBegin;
	C_SignMessageNext = functionList.C_SignMessageNext;
	C_MessageSignFinal = functionList.C_MessageSignFinal;
	C_MessageVerifyInit = functionList.C_MessageVerifyInit;
	C_VerifyMessage = functionList.C_VerifyMessage;
	C_VerifyMessageBegin = functionList.C_VerifyMessageBegin;
	C_VerifyMessageNext = functionList.C_VerifyMessageNext;
	C_MessageVerifyFinal = functionList.C_MessageVerifyFinal;
