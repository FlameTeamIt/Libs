#ifndef FLAMEIDE_SRC_CRYPTO_SOFTPKCS11_INTERFACE_RANDOMGENERATION_HPP
#define FLAMEIDE_SRC_CRYPTO_SOFTPKCS11_INTERFACE_RANDOMGENERATION_HPP
...
#endif // FLAMEIDE_SRC_CRYPTO_SOFTPKCS11_INTERFACE_RANDOMGENERATION_HPP
