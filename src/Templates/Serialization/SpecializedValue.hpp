#ifndef TEMPLATES_SERIALIZATION_SPECIALIZED_VALUE_HPP
#define TEMPLATES_SERIALIZATION_SPECIALIZED_VALUE_HPP

#include <Templates/ByteOrder.hpp>
#include <Templates/Serialization/ValueInfo.hpp>
...
#endif // TEMPLATES_SERIALIZATION_SPECIALIZED_VALUE_HPP
