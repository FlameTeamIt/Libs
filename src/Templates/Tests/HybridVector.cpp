...
using HybridVector = flame_ide::templates::HybridVector<TestClass, test::HybridVector::ARRAY_SIZE>;
using StdVector = std::vector<TestClass>;
using StdArray = std::array<TestClass, test::HybridVector::ARRAY_SIZE>;
...
bool HybridVector::containerAsArray()
{
...
bool HybridVector::containerAsVector()
{
...
bool HybridVector::fullTestAsArray()
{
...
bool HybridVector::fullTestAsVector()
{
