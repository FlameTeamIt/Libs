...
using NotificationTypeValue = CK_NOTIFICATION; // CKN_SURRENDER & CKN_OTP_CHANGED
...
using MechanismType = CK_MECHANISM_TYPE; // CKM_*
using MechanismTypePtr = CK_MECHANISM_TYPE_PTR;
