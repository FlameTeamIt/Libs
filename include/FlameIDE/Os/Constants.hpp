...
/// @brief
constexpr Status STATUS_FAILED =
		FLAMEIDE_OS_NAMESPACE::OS_STATUS_FAILED;
...
constexpr auto SOCKET_TCP_MAX_CLIENTS =
		FLAMEIDE_OS_NAMESPACE::OS_SOCKET_TCP_MAX_CLIENTS;
...
/// @brief
static constexpr SpinContext SPINLOCK_CONTEXT_INITIALIZER =
		FLAMEIDE_OS_NAMESPACE::OS_SPINLOCK_INITIALIZER;
