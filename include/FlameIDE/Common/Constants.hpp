...
#ifndef FLAMEIDE_CONSTANT_MAX_PIPE_BUFFER_SIZE
#	define FLAMEIDE_CONSTANT_MAX_PIPE_BUFFER_SIZE flame_ide::size_t(32)
#endif
...
struct Constants: public NonCreational
{
	...
	static constexpr flame_ide::size_t MAX_PIPE_BUFFER_SIZE =
			FLAMEIDE_CONSTANT_MAX_PIPE_BUFFER_SIZE * KILOBYTE;
};
